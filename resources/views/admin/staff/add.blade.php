    ...
    <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
      ...
      <div class="box-body col-sm-8">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="birthday" id="datepicker" value="{{ old('birthday') }}" placeholder="Birthday">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="re-password" class="col-sm-3 control-label">Re-type</label>
      ...
      <div class="box-footer">
        <div class="col-sm-8">
          <a href="{{ URL::route('admin.staff.getList') }}" class="btn btn-default">Return List </a>
